...
# RUN PROPOSED METHOD
post = Posterior(n_particles=100, theta_eff=true_noise / 2, prop_method=True, sequence_evolution=None,
...
# RUN FULLY BAYESIAN
post = Posterior(n_particles=100, theta_eff=true_noise / 2, prop_method=False, sequence_evolution=None,
                 sourcespace=sourcespace, data=data, prior_mean=[-5, 5], prior_theta=[2, 4],
                 max_exp=1, ess_min=0.99, ess_max=0.999, delta_min=1e-3, delta_max=1e-1,
                 point_spline=1e4, n_bins=10, verbose=True)
