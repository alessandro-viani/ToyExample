...
def var_plot(folder_name, saturation=0.7, linewidth=1, width=0.7, dpi=100, plot_show=True):
    ...
    plt.figure(figsize=(6, 7), dpi=100)
    sns.boxplot(data=[var_clas, var_prop], palette=['red', '#1f77b4'], saturation=saturation, width=width,
                linewidth=linewidth)
    plt.tick_params(axis='y', which='both', bottom=False, top=False, labelbottom=False)
    plt.ylabel(None)
    plt.xlabel(None)
...
def theta_plot(folder_name, saturation=0.7, linewidth=1, width=0.7, dpi=100, plot_show=True):
    ...
    sns.boxplot(data=[err_map_theta_clas, err_map_theta_prop], palette=['red', '#1f77b4'], saturation=saturation,
                width=width, linewidth=linewidth, ax=ax[0])
    sns.boxplot(data=[err_cm_theta_clas, err_cm_theta_prop], palette=['red', '#1f77b4'], saturation=saturation,
...
def error_parameter_plot(folder_name, size_ticks=22, fontsize=22, saturation=0.7, linewidth=1, width=0.7, dpi=100,
                         plot_show=True):
    with open(f'{folder_name}analitics.pkl', 'rb') as f:
        cpu_time_clas, cpu_time_prop, \
        kl_div, \
...
def cpu_time_plot(folder_name, size_ticks=22, fontsize=22, saturation=0.7, linewidth=1, width=0.7, dpi=100,
                  plot_show=True):
    with open(f'{folder_name}analitics.pkl', 'rb') as f:
        cpu_time_clas, cpu_time_prop, \
        kl_div, \
...
def all_plots(folder_name, size_ticks=22, fontsize=22, saturation=0.7, linewidth=1, width=0.7, dpi=100, plot_show=True):
    ...
    error_parameter_plot(folder_name, size_ticks=size_ticks, fontsize=fontsize, saturation=saturation,
                         linewidth=linewidth,
                         width=width, dpi=dpi, plot_show=plot_show)
    cpu_time_plot(folder_name, size_ticks=size_ticks, fontsize=fontsize, saturation=saturation, linewidth=linewidth,
                  width=width,
